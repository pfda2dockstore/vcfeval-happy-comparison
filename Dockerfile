# Generated by precisionFDA exporter (v1.0.3) on 2018-06-14 16:26:02 +0000
# The asset download links in this file are valid only for 24h.

# Exported app: vcfeval-happy-comparison, revision: 3, authored by: george.asimenos
# https://precision.fda.gov/apps/app-BxfGF8j02pBZzZxbzZxP725P
...
# Download app assets
RUN curl https://dl.dnanex.us/F/D/YYZXpV4YQ5xZkZ5305bfB0GGZpBxJVVJ74jkvFF3/ga4gh-stratification-bed-files-f35a0f7.tar | tar xf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/F0BFpv3VbqGQGkZ1k89g9FPB9ff04fFFYxVyxKZ9/hs37d5-fasta.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/pKZYQkXP7y256pB2jQ12YbGYj40X5b68Fpkf0X9Q/htslib-1.3.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/YfQfKx4yJX00BqBp368p2QZpb5v55fBVXYk18Q3q/pysam-0.9.1-pandas-0.18.1-numpy-1.11.0-Cython-0.24.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/jyzK1ybV4jVFBG7pQKKZ3QPbJ96B9jF9j5kbz5yg/rtg-hs37d5.tar | tar xf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/1YvZxx95K6jbV6Vvb0g6Zgg769f1ZX7YKv43pxK0/rtgtools-3.6-dev-ga4gh.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/Xb3KFBfQGqXj49qv673XZP5gyvPFxzGyBp6qb6xb/hap.py-HAP-207.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
...
RUN ["/bin/bash","-c","echo -E \\{\\\"spec\\\":\\{\\\"input_spec\\\":\\[\\{\\\"name\\\":\\\"query_vcf\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Query\\ VCF\\\",\\\"help\\\":\\\"The\\ GRCh37-based\\ VCF\\ \\(ideally\\ compressed\\ with\\ bgzip\\)\\ with\\ the\\ query\\ \\(test\\ set\\)\\ variants\\\"\\},\\{\\\"name\\\":\\\"truth_vcf\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Truth\\ VCF\\\",\\\"help\\\":\\\"The\\ GRCh37-based\\ VCF\\ \\(ideally\\ compressed\\ with\\ bgzip\\)\\ with\\ the\\ truth\\ \\(benchmark\\ set\\)\\ variants\\\"\\},\\{\\\"name\\\":\\\"truth_bed\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Truth\\ BED\\\",\\\"help\\\":\\\"A\\ BED\\ file\\ with\\ the\\ GRCh37\\ coordinates\\ corresponding\\ to\\ confident\\ regions\\ of\\ the\\ truth\\ VCF\\\"\\}\\],\\\"output_spec\\\":\\[\\{\\\"name\\\":\\\"extended_csv\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Extended\\ CSV\\ stats\\\",\\\"help\\\":\\\"A\\ CSV\\ file\\ with\\ extended\\ statistics\\ as\\ output\\ by\\ the\\ comparator\\\"\\},\\{\\\"name\\\":\\\"archived_results\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Results\\ archive\\\",\\\"help\\\":\\\"An\\ archive\\ containing\\ all\\ the\\ results\\ as\\ output\\ by\\ the\\ comparator\\\"\\}\\],\\\"internet_access\\\":false,\\\"instance_type\\\":\\\"baseline-8\\\"\\},\\\"assets\\\":\\[\\\"file-BxfFQKj0qVb1vqZf7104ZBJ4\\\",\\\"file-Bk5y43Q0qVb0gjfqY8f9k4g8\\\",\\\"file-BpBq6GQ0qVb40z0FGk4ZYjkY\\\",\\\"file-BxfFBK00qVb2XxX8X9FVxj50\\\",\\\"file-BqB6zV80qVb8Xb31P0B97jPg\\\",\\\"file-BvkQ5V8079PYVvxV3j9b9GQq\\\",\\\"file-BxfG8x00qVb40P5vk4X8xX3f\\\"\\],\\\"packages\\\":\\[\\]\\} \u003e /spec.json"]
